// Vendored from remocn (https://remocn.dev/r/mask-reveal-up.json) via the remocn registry API.
// Component: Mask Reveal Up
// NOTE: added an optional `align` prop (default "center", matching upstream) so this can be
// used as a left-aligned corner label as well as a centered headline.
"use client";

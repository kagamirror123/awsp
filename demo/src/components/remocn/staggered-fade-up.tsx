// Vendored from remocn (https://remocn.dev/r/staggered-fade-up.json) via the remocn registry API.
// Component: Staggered Fade Up
// NOTE: patched background from "white" to "transparent" for use inside dark scenes.
"use client";
